  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-3">
        <div className="flex space-x-3 md:space-x-2 bg-gradient-to-r from-sky-50 via-blue-50 to-sky-50 rounded-xl p-3 md:p-2">
          {users.map((member) => (
            <button
              key={member.id}
              ...
              className={`flex-1 py-5 px-4 md:py-4 md:px-3 rounded-xl font-medium text-base md:text-sm transition-all duration-300 ${
                selectedMember === member.id
                  ? 'bg-white text-sky-600 shadow-lg transform scale-105 ring-2 ring-sky-200'
            ...
            >
              <div className="flex flex-col items-center space-y-3 md:space-y-2">
                <div className={`transition-all duration-300 ${
                  selectedMember === member.id 
                    ? 'scale-110 ring-3 ring-sky-300 ring-offset-2 rounded-full' 
      ...
      {/* 설명 */}
      <div className="relative overflow-hidden bg-gradient-to-br from-sky-50 via-blue-50 to-sky-50 rounded-2xl border border-sky-100 shadow-sm">
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-sky-200/20 to-transparent rounded-bl-full"></div>
            ...
            <div className="flex-1">
              ...
              <div className="space-y-3 text-sm text-gray-700">
                <p className="flex items-center">
                  <span className="w-3 h-3 bg-gradient-to-r from-sky-400 to-sky-500 rounded-full mr-3 shadow-sm"></span>
                ...
                <p className="flex items-center">
                  <span className="w-3 h-3 bg-gradient-to-r from-sky-500 to-blue-600 rounded-full mr-3 shadow-sm"></span>
